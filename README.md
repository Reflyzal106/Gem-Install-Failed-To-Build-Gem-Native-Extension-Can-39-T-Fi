# [SOLVED] Gem-Install-Failed-To-Build-Gem-Native-Extension-Can-39-T-Fi
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/gem-install-failed-to-build-gem-native-extension-can-39-t-fi)
>
...
The issue is due to the missing MySQL development library. Install the mysql-server-devel package to fix the problem.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/gem-install-failed-to-build-gem-native-extension-can-39-t-fi)**
